...
Deploy actions are used to deploy new smart contracts to a blockchain network.
...
| **targetFunction** | Name of the function to call (e.g., `transfer`, `mint`) |
...
| **TargetFunction** | Required ✅ for call | Call | Function name (e.g., transfer, mint) |
...
<CardGroup cols={2}>
  ...
  <Card title="Use Cases" icon="lightbulb" href="/use-cases/token-transfer-alert">
