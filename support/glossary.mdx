---
title: 'Glossary'
description: 'Key terms and concepts in the KWALA ecosystem'
---
...
### KVM (KWALA Virtual Machine)
Execution environment for workflows. The KVM processes and executes your YAML-based workflows in a secure, isolated environment, handling all blockchain interactions and API calls.
...
### Exchange rate
Current conversion rate between USDT and KWALA credits (e.g., 49 USDT = 20 KWALA credits).
