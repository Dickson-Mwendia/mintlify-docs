...
KWALA operates on a credit-based system that powers your workflow executions. This guide explains how to acquire, manage, and monitor your KWALA credits.
...
<Steps>
  <Step title="Access payment portal">
    Visit [payments.kwala.network](https://payments.kwala.network/) and click "Connect Wallet" to access the portal.
  </Step>
...
Credits are automatically deducted when workflows execute. Credit usage is based on computational resources and complexity, ensuring transparent pricing. Credits are deducted based on several factors:

- **Workflow complexity**: More complex workflows with multiple actions consume more credits
- **Resource usage**: Gas fees, API calls, and computational resources affect credit usage
- **Execution time**: Longer-running workflows may use more credits
- **Failed executions**: Failed workflows may still consume minimal credits for processing attempts

## Monitoring your credits

You can monitor your credits usage in real-time on the Kwala dashboard. From  the dashboard, you can view your current credit balance in your wallet and track credit deductions for each workflow execution. Kwala also allows tou to set up notification alerts when credits are running low. If you'd like detailed insights into the transaction logs, use the [Kwala Explorer](https://kwala-explorer.lovable.app/)
