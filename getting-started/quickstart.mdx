...
KWALA supports multiple Web3 wallets such as MetaMask, Rainbow, Base Account, WalletConnect, and more.

<Info>
  This quickstart uses MetaMask as an example, but you can use any supported wallet.
</Info>
