...
<Steps>
  ...
  <Step title="Configure your workflow">
    ...
    If you prefer a more visual way to build your workflow instead of YAML, select the **Workflow Builder** button in the editor's top navigation pane. A new window pops up where you can use a form-based UI to configure triggers, actions, and execution settings. 

    <Frame>
      <img src="/images/getting-started/quickstart/kwala-workflow-builder.PNG" alt="KWALA workflow builder interface" />
    </Frame>

    In the workflow builder, fill in the:
    - Provide a name for your workflow
    - Add trigger configuration
    - Add upto 10 actions to execute when trigger conditions are met
